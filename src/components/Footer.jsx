  ...
  return (
    <footer className="bg-[#274156] pt-8 lg:pt-12 pb-12 lg:pb-12 mt-auto text-white">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 text-center lg:text-left">
        ...
        {/* Contact (real internal link) */}
        <div className="flex flex-col items-center md:items-end">
          <h4 className="font-bold mb-2 lg:mb-4 text-[11px] lg:text-sm uppercase tracking-wider text-white/60">Contacto</h4>
          <div className="text-sm text-white/80">
            <Link to="/contacto" className="hover:opacity-90">Formulario de contacto</Link>
          </div>
        </div>
      </div>
